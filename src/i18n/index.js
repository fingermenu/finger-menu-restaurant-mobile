  ...
  resources: {
    en_NZ: {
      translation: {
        ...
        yes: { button: 'Yes' },
        no: { button: 'No' },
        fullPayment: { button: 'Full Payment' },
        splitPayment: { button: 'Split Payment' },
        customPayment: { button: 'Custom Payment' },
        resetTable: { button: 'Reset Table' },
        home: { label: 'Home' },
    ...
    zh: {
      translation: {
        ...
        yes: { button: '是' },
        no: { button: '没有' },
        fullPayment: { button: '全额付款' },
        splitPayment: { button: '分期付款' },
        customPayment: { button: '自定义付款' },
        resetTable: { button: '重置表' },
        home: { label: '主界面' },
        homePage: { label: '主页' },
    ...
    jp: {
      translation: {
        ...
        yes: { button: 'はい' },
        no: { button: 'いいえ' },
        fullPayment: { button: '完全な支払い' },
        splitPayment: { button: '分割払い' },
        customPayment: { button: 'カスタム支払い' },
        resetTable: { button: 'リセットテーブル' },
        home: { label: 'ホーム' },
        homePage: { label: '' },
